    ...
    return (
        <footer className='w-full py-8 px-12 bg-themeTeal sticky top-0'>
            <div className='flex flex-col items-center border-themeYellow border-b-2 pb-8 mb-8'>
                <img src={logo} alt="logo ppm" className='w-20' />
            ...
            <div className='flex flex-col xl:flex-row gap-8 md:gap-20 md:w-10/12 mx-auto'>
                <div>
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.659044817672!2d110.41786237484689!3d-7.049291569075571!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e708bf981dc5289%3A0x648b79f844753a3c!2sPondok%20Pesantren%20Mahasiswa%20%22PPM%22%20Bina%20Khoirul%20Insan%20(LDII)!5e0!3m2!1sen!2sid!4v1695881104198!5m2!1sen!2sid" width="250" height="250" style={{border:0}} loading="lazy"></iframe>
                </div>
                <div>
                ...
                <div >
                    ...
                    <div className='flex gap-4 text-2xl'>
                        <div className='p-2 bg-white rounded-full flex items-center justify-center' onClick={() => window.open('https://web.facebook.com/ppm.insan', '_blank')}>
                            <BsFacebook />
                        </div>
                        <div className='p-2 bg-white rounded-full flex items-center justify-center' onClick={() => window.open('https://www.instagram.com/ppmbkisemarang/', '_blank')}>
                            <BiLogoInstagramAlt />
                        </div>
                        <div className='p-2 bg-white rounded-full flex items-center justify-center' onClick={() => window.open('https://www.youtube.com/@ppmbinakhoirulinsan1885', '_blank')}>
                            <FaYoutube />
                        </div>
                    </div>
                </div>
