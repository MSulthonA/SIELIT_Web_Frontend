...
function Beranda() {
    ...
    return (
        <div className="flex flex-col items-center justify-start relative">
            <Navbar className="bg-themeGray shadow-md items-center" />
            <img src={Hero} alt="Tampak depan PPM" className="-mt-28 mb-12 w-full h-96 md:h-full max-h-[65svh] object-cover -z-20 relative" />
            <p className="mb-12">
