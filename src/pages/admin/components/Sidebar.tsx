      ...
      <div className="flex w-full flex-col">
        ...
        <nav className="flex-1">
          <ul>
            ...
            <Link to="/admin/dataSantri" className="flex items-center p-4 text-gray-800 hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
              {isMinimized ? <IoPeople /> : <span>Data Santri</span>}
            </Link>
            <Link to="/admin/dataAkun" className="flex items-center p-4 text-gray-800 hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
            ...
            <Link to="/admin/dataRiwayatPresensi" className="flex items-center p-4 text-gray-800 hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
              {isMinimized ? <FaCalendarDays /> : <span>Data Akun</span>}
            </Link>
            ...
            <Link to="/admin/jadwalKelas" className="flex items-center p-4 text-gray-800 hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
            ...
            <Link to="/admin/bypassPresensi" className="flex items-center p-4 text-gray-800 hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
            ...
            <Link to="/admin/rekapPresensi" className="flex items-center p-4 text-gray-800 hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
            ...
            <Link to="/admin/dataPerizinan" className="flex items-center p-4 text-gray-800 hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
            ...
            <hr className="border-gray-400 dark:border-gray-700" />
            <Link to="/admin/perangkat" className="flex items-center p-4 text-gray-800 hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
