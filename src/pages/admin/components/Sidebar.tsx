    ...
    <div className={`left-0 fixed top-0 h-screen w-${isMinimized ? "16" : "80"} bg-white z-50 border-r shadow-md transition-all duration-300`}>
      <div className="flex w-full flex-col justify-between">
        ...
        <nav className="flex-1">
          <ul>
            <Link to="/admin/dataSantri" onClick={() => (isMinimized || window.innerWidth < 850) && toggleSidebar()}>
            ...
            <Link to="/admin/dataAkun" onClick={() => (isMinimized || window.innerWidth < 850) && toggleSidebar()}>
            ...
            <Link to="/admin/dataRiwayatPresensi" onClick={() => (isMinimized || window.innerWidth < 850) && toggleSidebar()}>
            ...
            <Link to="/admin/jadwalKelas" onClick={() => (isMinimized || window.innerWidth < 850) && toggleSidebar()}>
            ...
            <Link to="/admin/bypassPresensi" onClick={() => (isMinimized || window.innerWidth < 850) && toggleSidebar()}>
            ...
            <Link to="/admin/rekapPresensi" onClick={() => (isMinimized || window.innerWidth < 850) && toggleSidebar()}>
            ...
            <Link to="/admin/dataPerizinan" onClick={() => (isMinimized || window.innerWidth < 850) && toggleSidebar()}>
            ...
            <hr className="border-gray-400" />
            <Link to="/admin/perangkat" onClick={() => (isMinimized || window.innerWidth < 850) && toggleSidebar()}>
