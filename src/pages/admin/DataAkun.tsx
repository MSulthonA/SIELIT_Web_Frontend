...
function DataAkun() {
  ...
  function handleSubmit(e: any) {
    ...
    axios
      .post(`${appSettings.api}/users`, account, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  function handleEdit(e: any) {
    ...
    axios
      .put(`${appSettings.api}/users`, account, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
    ...
    <div className="min-h-[100svh] flex flex-col items-center justify-start w-full pt-4 pb-16 grow overflow-x-scroll ">
      ...
      {mode === "form" ? (
        ...
        >
          ...
          <TextInput
            name={account.id ? "passwordNew" : "password"}
            value={account.id ? account.passwordNew : account.password}
            title={account.id ? "Password baru (opsional)" : "password"}
            errorMsg={account.id ? account.passwordNewErr : account.passwordErr}
